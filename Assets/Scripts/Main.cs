...
public class Main : MonoBehaviour
{
	...
	void Start ()
	{
		...
		for (int i = 0; i < blocks.Count; i++) 
		{
			...
			UIEventListener.Get(go.transform.gameObject ).onClick = onClickBlock;
...
//			this._tex = tex;
	...
	public class Block
	{
		...
		public Block (int indexX, int indexY, int countX, int countY, int sizeX, int sizeY)
		{
			...
			this.posX = (indexX - countX / 2) * sizeX;
	...
	public static GameObject AddChild (GameObject pParent, string pName = null, GameObject pPrefab = null)
	{
		...
		if (pParent != null) 
		{
			...
			t.localRotation = Quaternion.Euler(0, 0, RandomRotationAngle());
	...
	static float RandomRotationAngle()
	{
